 ...
 */
export declare type SemanticMethod = (config: Config, context: Context) => any;
/**
 ...
 */
export declare type VersionBumper = (meta: ManifestMeta, config: Config, context: Context) => Manifest;
/**
 ...
 */
export declare type VersionCalculator = (meta: ManifestMeta, config: Config, context: Context) => string;
